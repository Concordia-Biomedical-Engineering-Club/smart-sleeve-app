        ...
        <View style={styles.listContainer}>
          {EXERCISE_LIBRARY.map((exercise) => {
            ...
            return (
              ...
              >
                <View
                  style={[styles.accentTag, { backgroundColor: accentColor }]}
                />
                <View style={styles.cardBody}>
                  <View style={styles.cardHeader}>
                    <ThemedText type="bodyBold" style={styles.exerciseName}>
                      {exercise.name}
                    </ThemedText>
                    <View
                      style={[
                    ...
                    >
                      <Text style={[styles.focusText, { color: accentColor }]}>
                  ...
                  <View style={styles.metricGrid}>
                    ...
                    <View style={styles.metricItem}>
                      ...
                      <ThemedText style={styles.metricValue}>
                        {exercise.workDurationSec}s Hold
                      </ThemedText>
                    </View>
                  </View>
                  ...
                  >
                    <ThemedText
                      type="label"
                      style={[styles.tipTitle, { color: accentColor }]}
                    >
                      COACH TIP
                    </ThemedText>
          ...
          <>
            <TouchableOpacity
              style={[
                ...
                { backgroundColor: theme.success, ...Shadows.button },
              ]}
          ...
          {(["LEFT", "RIGHT"] as const).map((side) => (
            <TouchableOpacity
              ...
              style={[
                ...
                {
                  backgroundColor:
                    selectedSide === side ? theme.primary : theme.secondaryCard,
                  borderColor:
                    selectedSide === side ? theme.primary : theme.border,
                },
              ]}
            ...
            >
              <ThemedText
                style={[
                  ...
                  {
                    color: selectedSide === side ? "#fff" : theme.textSecondary,
                  },
                ]}
              >
