...
export default function DashboardPage() {
  ...
  if (error) {
    const isPermissionError =
      error.includes("permissions") || error.includes("denied");
    return (
          ...
          <div className="space-y-4">
            <Link
              ...
              className={cn(
                ...
                "w-full h-12 rounded-xl text-lg font-bold shadow-xl shadow-primary/20 flex items-center justify-center",
              )}
            >
            ...
            <p className="text-sm text-muted-foreground">
              ...
              <span className="text-foreground font-bold">
                {patients[0]?.email || "Authenticated User"}
              </span>
            </p>
          </div>
        </Card>
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Monitor patient recovery metrics and identify at-risk trends at a
            glance.
          </p>
        </div>
