      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <Card className="md:col-span-2 border-none bg-card/40 backdrop-blur-md">
          <CardHeader>
            ...
            <CardDescription>
              Your details as they appear on patient clearance reports and
              certificates.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="flex flex-col md:flex-row gap-6">
              <div className="space-y-2 flex-1">
                ...
                <div className="relative">
                  ...
                  <Input
                    id="name"
                    defaultValue={user?.displayName || "Dr. Sarah Evans"}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  id="clinic"
                  defaultValue="Concordia Orthopedics & Sports Med"
                  className="pl-10 bg-background/50 border-border/50 h-11 rounded-xl"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  id="website"
                  defaultValue="https://concordiaortho.com"
                  className="pl-10 bg-background/50 border-border/50 h-11 rounded-xl"
                />
              </div>
            </div>
